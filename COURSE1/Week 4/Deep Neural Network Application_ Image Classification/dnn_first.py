...
def update_parameters(parameters, grads, learning_rate):
    ...
    ### START CODE HERE ### (≈ 3 lines of code)
    for l in range(L):
        parameters["W" + str(l+1)] = parameters["W" + str(l+1)] - np.dot(grads["dW" + str(l + 1)],learning_rate)
        parameters["b" + str(l+1)] = parameters["b" + str(l+1)] - np.dot(grads["db" + str(l + 1)],learning_rate)
    ### END CODE HERE ###
