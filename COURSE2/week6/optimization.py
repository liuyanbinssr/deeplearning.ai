...
def random_mini_batches(X, Y, mini_batch_size = 64, seed = 0):
    ...
    #用法: b.shape(4,4) b=a[:,[0,1,2,3]] b=a[[0,2,3,1],[0,1,3,2]]。切片里的洗牌方法
...
def update_parameters_with_momentum(parameters, grads, v, beta, learning_rate):
    ...
    for l in range(L):
        ...
        v["db" + str(l+1)] = beta*v["db" + str(l+1)] + (1-beta)*grads["db" + str(1+l)]
        # update parameters
...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(L):
        ...
        ### START CODE HERE ### (approx. 2 lines)
        v["dW" + str(l+1)] = beta1*v["dW" + str(l+1)] + (1-beta1)*grads["dW" + str(1+l)]
        v["db" + str(l+1)] = beta1*v["db" + str(l+1)] + (1-beta1)*grads["db" + str(1+l)]
        ### END CODE HERE ###
